...
// function PhoneScreen<StackScreenProps>({ navigation }) {
//   /* Cброс пароля начало */
//   const resetPassword = () => {
//     if (email!=null) {
//         sendPasswordResetEmail(auth, email)
//             .then(() => {
//                alert("Письмо с новым паролем отправлено на Вашу электронную почту!")
//             })
//             .catch((error) => {
...
//               <Text className="font-title text-xl font-bold text-left" style={{color: "#056CF2", marginBottom: "10%"}}>
